...
import UltimosPartidos from "./Inicio/PartidosUltimos.jsx";
...
function Inicio() {
    ...
    useEffect(() => {
        axios
            ...
            .then((res) => setUltimosPartidos(res.data))
    ...
    return (
        <main className="inicio">
            <section className="bienvenida">
                ...
                >
                    {!textoTerminado ? (
                        ...
                        <p>
                            Tu base de datos de futbol preferida donde podrás
                            ver el recuento histórico de las principales ligas
                            del mundo
                        </p>
                    )}
                </motion.div>
                ...
                <div className="panel-derecho">
                    <div className="filtro-continente">
                        ...
                        <Select
                            ...
                            className="select"
                            options={continentes}
                            value={continentes.find(
                                (c) => c.value === filtroContinente
                            )}
                            onChange={(e) =>
                                setFiltroContinente(e ? e.value : null)
                            }
                            styles={customStyles}
            ...
            <motion.section
                className="partidos-ultimos"
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.5 }}
            >
                <div className="partidos-lineas">
                    <h2>Últimos partidos:</h2>
                    {ultimosPartidos.map((partido, index) => (
                        <UltimosPartidos key={index} partido={partido} />
                    ))}
                </div>
            </motion.section>
        </main>
